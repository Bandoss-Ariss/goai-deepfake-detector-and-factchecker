...
class DenseNet121DeepFakeFineTuned(nn.Module):
    def __init__(self, hidden_dim, reduced_feature_dim=512, feature_dim=1024):
        super().__init__()
        ...
        for name, param in self.feature_extractor.named_parameters():
            if 'features.denseblock4.denselayer16' not in name:
